...
const Settings = ({ navigation }) => {
    ...
    const [email, setEmail] = useState('anuhasmithum@gmail.com');
    const [fullName, setFullName] = useState('User Name');

    return (
        <View style={styles.container}>
            <TouchableOpacity onPress={() => navigation.navigate('Medications')}>
                <Image style={styles.image} source={{ uri: "https://www.gstatic.com/webp/gallery3/1.sm.png" }} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.infomation} onPress={() => navigation.navigate('Medications')}>
                <View>
